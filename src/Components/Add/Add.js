...
const Add = () => {
  ...
  return (
    <div className="container">
      <div className="row">
        <div className="display-3 text-center mt-5">Add Contact</div>
        <div className="col-md-6 shadow mx-auto p-5 mt-5">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group column gx-5">
              <input
                className="btn btn-block btn-outline-success mt-4 w-50 ms-5"
                type="submit"
                value="Add"
              />
              <Link
                className="btn btn-block btn-outline-danger mt-4 w-25 ms-5"
                to="/"
              >
